    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('buesness_logo', models.ImageField(blank=True, null=True, upload_to='buesnesslogo/image')),
                ('owner_photo', models.ImageField(upload_to='buesnessowner/photo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='rider/images')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('CANCELLED', 'Cancelled'), ('APPROVED', 'Approved')], default='PENDING', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proved_video', models.FileField(upload_to='', verbose_name='order_proved_videos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orderitem', related_query_name='orderitem', to='api.product')),
            ],
        ),
        migrations.CreateModel(
            name='CartItem',
